...
TEST(Dataset, mnist)
{
    ...
    Ag::DataSetModel::MNIST trainData(std::string("datasets/mnist/train/train-labels-idx1-ubyte"), std::string("datasets/mnist/train/train-images-idx3-ubyte"));
    ...
    Ag::DataSetModel::MNIST testData(std::string("datasets/mnist/test/t10k-labels-idx1-ubyte"), std::string("datasets/mnist/test/t10k-images-idx3-ubyte"));
...
TEST(Dataset, fashionMnist)
{
    std::chrono::time_point<std::chrono::system_clock> start, end;
    start = std::chrono::system_clock::now();
	Ag::DataSetModel::MNIST trainData(std::string("datasets/Fashion-MNIST/train/train-labels-idx1-ubyte"), std::string("datasets/Fashion-MNIST/train/train-images-idx3-ubyte"));
    ...
    Ag::DataSetModel::MNIST testData(std::string("datasets/Fashion-MNIST/test/t10k-labels-idx1-ubyte"), std::string("datasets/Fashion-MNIST/test/t10k-images-idx3-ubyte"));
