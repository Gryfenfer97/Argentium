...
TEST(Dataset, mnist)
{
    ...
    Ag::DataSetModel::MNIST trainData("./datasets/MNIST/train-labels.idx1-ubyte"s, "./datasets/MNIST/train-images.idx3-ubyte"s);
    ...
    Ag::DataSetModel::MNIST testData("./datasets/MNIST/t10k-labels.idx1-ubyte"s, "./datasets/MNIST/t10k-images.idx3-ubyte"s);
...
TEST(Dataset, fashionMnist)
{
    ...
    std::chrono::time_point<std::chrono::system_clock> start, end;
    start = std::chrono::system_clock::now();
    Ag::DataSetModel::MNIST trainData("./datasets/Fashion-MNIST/train-labels-idx1-ubyte"s, "./datasets/Fashion-MNIST/train-images-idx3-ubyte"s);
    ...
    Ag::DataSetModel::MNIST testData("./datasets/Fashion-MNIST/t10k-labels-idx1-ubyte"s, "./datasets/Fashion-MNIST/t10k-images-idx3-ubyte"s);
